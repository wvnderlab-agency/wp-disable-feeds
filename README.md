...
![WP Coding Standards](https://github.com/wvnderlab-agency/wp-disable-feeds/actions/workflows/wp-coding-standards.yml/badge.svg)](https://github.com/wvnderlab-agency/wp-disable-feeds/actions/workflows/wp-coding-standards.yml)
...
```shell
composer require wvnderlab-agency/wp-disable-feeds
```
...
5. Find 'Disable feeds' in the list and click 'Activate'.
...
#### wvnderlab/disable-feeds/enabled *(Default: true)*

This filter allows you to disable the plugin functionality.

```php
// disable the plugin functionality
add_filter( 'wvnderlab/disable-feeds/enabled', '__return_false' );
```
